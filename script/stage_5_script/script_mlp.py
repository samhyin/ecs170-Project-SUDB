...
from local_code.stage_5_code.Method_MLP import Method_MLP
...
def main():
    ...
    data_dir = resolve_stage_data_dir('stage_5_data', ('train.csv', 'test.csv'))
    result_dir = ensure_result_dir('stage_5_result')

    data_obj = Dataset_Loader('stage 5 inherited MLP template', 'Pre-split train/test dataset template')
    ...
    method_obj = Method_MLP('multi-layer perceptron', 'Stage 5 inherited multiclass MLP template')
    method_obj.curve_output_path = result_dir / 'stage_5_loss_curve.png'
    ...
    print(f'using stage 5 result directory: {result_dir}')
