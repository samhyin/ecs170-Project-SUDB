...
from local_code.stage_5_code.Method_SVM import Method_SVM
from local_code.stage_5_code.Result_Saver import Result_Saver
from local_code.stage_5_code.Setting_KFold_CV import Setting_KFold_CV
...
if 1:
    ...
    result_obj.result_destination_folder_path = '../../result/stage_5_result/SVM_'
