...
def main():
    ...
    data_dir = resolve_stage_data_dir('stage_2_data', ('train.csv', 'test.csv'))
    result_dir = ensure_result_dir('stage_2_result')

    data_obj = Dataset_Loader('mnist stage 2', 'Pre-split MNIST train/test dataset')
    ...
    method_obj = Method_MLP('multi-layer perceptron', 'Stage 2 multiclass MLP')
    method_obj.curve_output_path = result_dir / 'stage_2_loss_curve.png'
    ...
    print('************ Start ************')
    print(f'using stage 2 data directory: {data_dir}')
    print(f'using stage 2 result directory: {result_dir}')
